...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark "
        style="position: fixed; z-index: 1000; top:0; width: 100%; background-color: black;">
        <div class="container-fluid">
            ...
            <div>
                ...
                <a href="cart.html" style="font-size:20px; text-decoration:none; color:white;"
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-3">
                    ...
                    <ul class="footer-links">
                        <li><a href="http://scanfcode.com/category/c-language/">Recommend</a></li>
                        <li><a href="http://scanfcode.com/category/front-end-development/">Cake</a></li>
                        <li><a href="http://scanfcode.com/category/back-end-development/">Cookies</a></li>
                        <li><a href="http://scanfcode.com/category/java-programming-language/">Drink</a></li>
                        <li><a href="http://scanfcode.com/category/android/">Snack</a></li>
                    </ul>
                </div>
